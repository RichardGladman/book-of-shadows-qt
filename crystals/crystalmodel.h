#ifndef CRYSTALMODEL_H
#define CRYSTALMODEL_H
...
public:
    ...
    static CrystalModel load(int id);

    CrystalModel(int id, QString name, QString description, int planet_id=0, int polarity_id=0, int zodiac_id=0);
